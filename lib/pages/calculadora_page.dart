import 'package:calculator_math/controllers/calculadora_controller.dart';
    ...
    return AppBar(
      ...
      actions: <Widget>[
       new IconButton(
          ...
          onPressed: () {
            Share.share('Bem vindo a calculadora em flutter, compartilhe com os outros e bons calculos!');
          },
        ),
      ],
      iconTheme: IconThemeData(color: Colors.grey),
      textTheme: TextTheme(title: TextStyle(color: Colors.white12, fontSize: 32.0),),
    );
  }
